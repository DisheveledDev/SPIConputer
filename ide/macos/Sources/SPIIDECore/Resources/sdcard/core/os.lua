...
-- Built 2026-09-15T09:27:08Z from components:
--   snippet header
--   lua     screen
--   lua     line-editor
--   lua     commands
...
-- ==== sdk: text (read-only; nothing used, nothing emitted) ====

-- ==== sdk: timer (read-only; nothing used, nothing emitted) ====

-- ==== sdk: sound (read-only; nothing used, nothing emitted) ====

-- ==== sdk: input (read-only; nothing used, nothing emitted) ====
